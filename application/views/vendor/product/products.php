              ...
              <table class="table table-bordered" style="border-style: dashed" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php $i = 0; foreach($products as $product) { $i++?>
                  <tr>
                    ...
                    <td><?php if($product->sc == 1) echo 'A/V'; else echo 'N/A'; ?></td>
                    <td><?php if($product->size_color->count()) echo $product->size_color->sum('qt'); else echo $product->product_quantity; ?> <?= $product->sell_unit?></td>
                    <td><?= $product->display_price ?> <?= $product->currency ?></td>
                    <!--<td><?= $product->type->type_name ?></td>-->
                    <td>
                        <a 
                            href="<?=base_url()?>product_ctrl/product_details/<?=$product->id?>" 
