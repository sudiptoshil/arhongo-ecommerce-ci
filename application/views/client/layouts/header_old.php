			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="cart-links">
						...
						<?php } ?>
						<a onclick="cart_data_display()" style="cursor:pointer"><i class="fa fa-shopping-cart"></i> <span id="total-cart-item"></span></a>
		...
		<div class="container">
			...
			<nav class="navbar navbar-inverse custom-nav">
				<!--<div class="navbar-header">-->
					...
					<!--	<span class="icon-bar"></span>-->
					<!--</button>-->
					<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample01" aria-controls="navbarsExample04" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon" style="background-image:url(<?= base_url('client_assets/images/expand.jpg') ?>)"></span>
      </button>
				...
				<div class="navbar-collapse collapse" id="navbarsExample01" style="">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item"><a class="nav-link" href="<?= base_url('welcome/client') ?>">Home</a></li>
						...
						<li class="dropdown mega-dropdown nav-item" >
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"><?= $root_category['category_name'] ?>
							<span class="caret"></span>
							</a>
							<ul class="dropdown-menu mega-dropdown-menu">
							    <?php $level_one = $this->db->where('root_id',$root_category['id'])->get('product_category')->result_array(); ?>
								...
								<li class="col-sm-3">
									...
									<a href="<?= base_url('client_controllers/main_ctrl/sub_categories/'.$lvl_one['id']) ?>"><li class="dropdown-header text-center"><?= $lvl_one['category_name'] ?></li></a>
										...
										?>
										    <li class="text-center"><a href="<?= base_url('client_controllers/main_ctrl/sub_categories/'.$lvl_two['id']) ?>"><?= $lvl_two['category_name'] ?></a></li>
										<?php }} ?>
						...
						<?php } ?>
					<!--<li class="nav-item"><a class="nav-link" href="<?= base_url('welcome/client') ?>">Home</a></li>-->
						<li class="nav-item"><a class="nav-link" href="<?= base_url('welcome/about') ?>">About Us</a></li>
						<li class="nav-item"><a class="nav-link" href="<?= base_url('welcome/contact') ?>">Contact Us</a></li>

						<?php if($this->session->userdata('customer_id') !== null){ ?>
						<li class="dropdown mega-dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Orders <span
									class="caret"></span></a>
							<ul class="dropdown-menu mega-dropdown-menu">
								<li class="col-sm-3">
									<ul>
										<li class="dropdown-header">Order Details</li>
										<li><a href="<?= base_url('client_controllers/order_ctrl/customer_orders') ?>">All Pending Orders</a></li>
									</ul>
								</li>
