	    ...
	    <div class="slider_area">
            <div id="carousel" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                 ...
                 Wrapper for slides 
                <div class="carousel-inner" role="listbox" id="my_div">
                  ...
                  ?>
                    <div class="item <?php echo $isActive ?>">
                        <img src="<?= base_url("assets/img/slider/".$slider['slider_image']) ?>">
                    </div>
                 <?php } ?> 
                    <div class="item active">
                        <img src="<?= base_url() ?>client_assets/img/slider_01.png">
                    </div>
                    <div class="item">
                        <img src="<?= base_url() ?>client_assets/img/slider_02.png">
                    </div>

                    <div class="item">
                       <img src="<?= base_url() ?>client_assets/img/slider_03.png">
                   </div>
                </div>
            </div>
        </div>
		...
		<div class="col-xs-12 col-md-12 col-lg-12 col-centered">
			...
			<div id="carousel" class="carousel slide" data-ride="carousel" data-type="multi" data-interval="2500">
				<div class="carousel-inner">
				    <?php foreach($root_categories as $key=>$cat){ ?>
					<div class="item <?= $key == 0 ? 'active' : '' ?>">
						
						<a href="<?= base_url('client_controllers/main_ctrl/sub_categories/'.$cat['id']) ?>">
						    <div class="carousel-col">
						    <hr>
						    <h4 class="text-center"><?= $cat['category_name'] ?></h4>
							<!--<div class="block red img-responsive"></div>-->
							<img src="<?= base_url('assets/img/category/'.$cat['category_image']) ?>" style="max-height:200px;" />
						    </div>
						</a>
					</div>
					<?php } ?>
